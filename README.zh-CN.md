...
本 README 是中文完整版：按方向总结具身智能前沿，并把已读公开来源中明确归属 CCF-A 会议的论文整理为细粒度表格。

## 快速入口

- 如果只想看整体版图，先读 [方向总览表](#方向总览表)。
- 如果想按论文细查，直接进入 [各方向详细表格](#各方向详细表格)。
- 如果想知道先读什么，看 [重点阅读顺序](#重点阅读顺序)。
- 如果想追溯来源，看 [数据来源说明](#数据来源说明) 和 [`sources/github/readmes`](sources/github/readmes)。
