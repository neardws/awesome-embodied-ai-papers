...
<td nowrap>大规模仿真抓取、扩散式抓取生成已有较多基线</td>
<td nowrap>真机泛化、物理可行性、复杂接触仍不稳</td>
...
<td nowrap>仿真和少量真机任务已有方法</td>
<td nowrap>接触动力学 reality gap、长时稳定性</td>
...
<td nowrap>特定任务已有策略和仿真器</td>
<td nowrap>真实接触不确定性、传感器耐用性、闭环控制</td>
