...
This README is the complete English version: it organizes frontier embodied AI directions and provides detailed paper-level tables for public sources clearly associated with CCF-A venues.

## Quick Access

- For the field map, read [Direction Overview](#direction-overview).
- For paper-level details, jump to [Detailed Tables](#detailed-tables).
- For the suggested reading sequence, see [Reading Order](#reading-order).
